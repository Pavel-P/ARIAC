...
ariac::KittingShipmentScore AriacScorer::GetKittingShipmentScore(
  ...
  ignition::math::Vector3d movable_tray_trans_diff(
    expected_movable_tray_position.x - detected_movable_tray_position.x,
  ...
  ignition::math::Quaterniond expected_orientation(
    expected_movable_tray_orientation.w,
    expected_movable_tray_orientation.x,
    expected_movable_tray_orientation.y,
    expected_movable_tray_orientation.z);

  ignition::math::Quaterniond detected_orientation(
    detected_movable_tray_orientation.w,
    detected_movable_tray_orientation.x,
    detected_movable_tray_orientation.y,
  ...
  scorer.has_correct_movable_tray_pose = scorer.has_correct_movable_tray_orientation && scorer.has_correct_movable_tray_position;
    ...
    do {
      ...
      for (size_t d = 0; d < expected_indexes.size(); ++d) {
        ...
        ignition::math::Vector3d posnDiff(
          expected_product.pose.position.x - detected_product.pose.position.x,
          expected_product.pose.position.y - detected_product.pose.position.y,
          0);
        ...
        ignition::math::Quaterniond expectedOrientation(
          expected_product.pose.orientation.w,
          expected_product.pose.orientation.x,
          expected_product.pose.orientation.y,
          expected_product.pose.orientation.z);

        ignition::math::Quaterniond detectedOrientation(
          detected_product.pose.orientation.w,
          detected_product.pose.orientation.x,
          detected_product.pose.orientation.y,
          detected_product.pose.orientation.z);
      ...
      for (size_t d = 0; d < desired_indexes.size(); ++d) {
        ...
        for (const auto& wrong_color_product : wrong_color_products) {
          ...
          if (actual_product_type.compare(desired_product_type) == 0) {
            ...
            // get translation distance
            ignition::math::Vector3d posnDiff(
              desired_product.pose.position.x - wrong_color_product.pose.position.x,
              desired_product.pose.position.y - wrong_color_product.pose.position.y,
              0);
            ...
            ignition::math::Quaterniond detectedOrientation(
              wrong_color_product.pose.orientation.w,
              wrong_color_product.pose.orientation.x,
              wrong_color_product.pose.orientation.y,
              wrong_color_product.pose.orientation.z);
